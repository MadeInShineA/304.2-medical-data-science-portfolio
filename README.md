...
This repo contains the content of my portfolio done in the 304.2 - Semester
project course

## Website

This project website is available
[here](https://olivier.amacker.dev/304.2-medical-data-science-portfolio/index.html)
or locally at `_site/index.html`
...
2. Clone the repository
   ...
   cd 304.2-medical-data-science
   ```
3. Enter the development shell This provides Quarto and all project dependencies
